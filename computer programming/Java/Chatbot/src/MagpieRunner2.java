...
KeyListener {
		...
		for (int j = 0; j < Words.length; j++) {
			...
			if (!any) {
				java.awt.Desktop
						.getDesktop()
						.browse(java.net.URI
								.create("https://www.google.com/webhp?tab=ww&authuser=0&ei=f4tqVLCLEYThsASR4oHwDg&ved=0CAcQ1S4#authuser=0&q=define+"
										+ Words[j]));
				Response.setText("Define " + Words[j]);
				findDefinition(Words[j]);
				learn();
				break;
			}
		}
	...
	public static final String findDefinition(String word) {
