...
public class TestAverage2 extends JFrame implements ActionListener, KeyListener {
	...
	public static void main(String[] args) {
		TestAverage2 window = new TestAverage2();
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (arg0.getSource() == checkname|| b==true) {
			NAMEcheck();
		}
		if (arg0.getSource() == checkscore||c==true) {
			SCOREcheck();
		}
	}
